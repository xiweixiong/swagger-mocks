...
exports.StandardDataSource = exports.BaseClass = exports.Mod = exports.Interface = exports.Property = exports.StandardDataType = exports.PrimitiveType = void 0;
...
class Property extends Contextable {
    ...
    toPropertyCode(surrounding = utils_1.Surrounding.typeScript, hasRequired = false, optional = false) {
        ...
        const fieldTypeDeclaration = surrounding === utils_1.Surrounding.javaScript ? '' : `${optionalSignal}: ${this.dataType.generateCode(this.getDsName())}`;
        return `
...
class Interface extends Contextable {
  ...
  `;
    ...
    getRequestParams(surrounding = utils_1.Surrounding.typeScript) {
        ...
        return paramList.map((param) => `${param.paramKey}${param.initialValue ? ` = ${param.initialValue}` : ''}`).join(', ');
    }
    getBodyParamsCode() {
