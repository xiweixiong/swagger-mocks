    ...
    return __awaiter(this, void 0, void 0, function* () {
        ...
        if (configPath) {
            const result = yield inquirer.prompt({
                ...
                name: 'confirm',
                default: true,
                message: `检测到已存在mocks-config文件，继续生成将覆盖配置项，是否继续？`,
            });
            if (!result.confirm) {
                return;
            }
        ...
        debugLog.info(`
    其余配置项请参阅官方文档 https://github.com/xiweixiong/swagger-mocks#readme
  `);
    });
}
...
function generateConfig(configPath, answers) {
    ...
    const dirName = path.join(process.cwd(), utils_1.CONFIG_FILE);
  ...
  `;
    const formatStr = utils_1.format(configStr, Object.assign(Object.assign({}, config.prettierConfig), { printWidth: 120 }));
